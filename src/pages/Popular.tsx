...
const Popular = () => {
  ...
  const { data, fetchNextPage, hasNextPage, status } = useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) => getMoviesPaginated(`https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=false&language=en-US&sort_by=popularity.desc`, pageParam),
